(function (global, factory) {
	...
	*/
	...
	Object.assign( Rotational3Constraint.prototype, {
		...
		/**
		 * A complex joint allows unique limit motors on all axis
		 *
		 * @author saharan
		 * @author lo-th
		...
		function ComplexJoint ( config, lowerAngleLimit, upperAngleLimit ) {

		    Joint.call( this, config );

		    this.type = JOINT_COMPLEX;
		...
		ComplexJoint.prototype = Object.assign( Object.create( Joint.prototype ), {

		    constructor: ComplexJoint,
	...
	function HingeJoint ( config, lowerAngleLimit, upperAngleLimit ) {
	    ...
	    // The rotational limit and motor information of the joint.
	    this.limitMotor = new LimitMotor( this.nor, false );
			this.limitMotor2 = new LimitMotor( this.tan, true );
			this.limitMotor3 = new LimitMotor( this.bin, true );

			// console.log( 'config', lowerAngleLimit, upperAngleLimit );

	    this.limitMotor.lowerLimit = Array.isArray( lowerAngleLimit ) ? lowerAngleLimit[0] : lowerAngleLimit;
	    this.limitMotor.upperLimit = Array.isArray( upperAngleLimit ) ? upperAngleLimit[0] : upperAngleLimit;
			this.limitMotor2.lowerLimit = lowerAngleLimit[1] || 0;
			this.limitMotor2.upperLimit = upperAngleLimit[1] || 0;
			this.limitMotor3.lowerLimit = lowerAngleLimit[2] || 0;
			this.limitMotor3.upperLimit = upperAngleLimit[2] || 0;

			console.log( this.limitMotor, this.limitMotor2, this.limitMotor3 );

	    this.lc = new LinearConstraint( this );
	    this.r3 = new Rotational3Constraint( this, this.limitMotor, this.limitMotor2, this.limitMotor3 );
	}
	...
	HingeJoint.prototype = Object.assign( Object.create( Joint.prototype ), {
	    ...
	    preSolve: function ( timeStep, invTimeStep ) {
	        ...
	        this.r3.limitMotor3.angle = _Math.dotVectors( this.bin, this.tmp );
					...
					//console.log( 'lm1', this.limitMotor );
					//console.log( 'lm2', this.limitMotor2 );
					//console.log( 'lm3', this.limitMotor3 );
	    ...
	    initJoint: function( type, o ){
	        ...
	        if( type === "jointDistance" ){
	            ...
	            max = max * invScale;
						...
						if ( Array.isArray( o.min ) && Array.isArray( o.max ) )
							{
								min = [];
								max = [];
								for ( let x in o.min )
								{
									min.push( o.min[x] || 0 );
									max.push( o.max[x] || 0 );
									min[x] = min[x] * _Math.degtorad;
									max[x] = max[x] * _Math.degtorad;
								}
							}
							else
							{
	        ...
	        switch( type ){
	            ...
	            break;
							case "jointComplex": case "joint": joint = new ComplexJoint(jc, min, max);
